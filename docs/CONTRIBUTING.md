# Contributing to Plugin Skeleton D

Thank you for your interest in contributing to Plugin Skeleton D! We welcome contributions from the community to help improve the project. This document outlines how you can contribute, including reporting issues, submitting code, and our code of conduct.

## Code of Conduct

Please read and follow our [Code of Conduct](./CODE_OF_CONDUCT.md) to ensure a welcoming environment for all contributors. If you encounter any issues or wish to report a concern, please email us at [@todo@rtcamp.com](mailto:@todo@rtcamp.com).
...
> [!IMPORTANT]
>
> **Do not report potential security vulnerabilities in the public GitHub repository.** Instead, please email us at [@todo@rtcamp.com](mailto:@todo@rtcamp.com).
>
> For more information, refer to our [Security Policy](./SECURITY.md).

If you find a bug or have a feature request, please open an issue in the [GitHub Issues](https://github.com/rtCamp/plugin-skeleton-d) section. Provide as much detail as possible, including:
...
> [!TIP]
>
> **Note**: Before opening a new issue, please search the [GitHub Issues](https://github.com/rtCamp/plugin-skeleton-d/issues) to see if a similar issue has already been reported.
>
...
We appreciate your time and contributions to Plugin Skeleton D. Your efforts help make this project better for everyone!
